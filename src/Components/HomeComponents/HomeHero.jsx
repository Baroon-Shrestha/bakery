...
export default function HomeHero() {
  ...
  const titleWords = "Welcome to Our Bakery".split(" ");
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                  ...
                  >
                    ...
                    <div className="relative cursor-pointer">
                      <div className="bg-gradient-to-br from-[#009F8A] to-teal-600 rounded-full px-8 py-2 lg:px-12 lg:py-4 text-center shadow-2xl border-4 text-center border-white/20">
