...
export default function HomeProducts() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: "Box of 6 • Pastry cream filled",
      price: 280,
      rating: 4.8,
      reviews: 167,
      popular: false,
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1607958996333-41aef7caefaa?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      description: "Box of 6 • Organic berries",
      price: 200,
      rating: 4.6,
      reviews: 92,
      popular: false,
    },
    {
      ...
      description: "Individual portion • Made fresh",
      price: 120,
      rating: 4.9,
      reviews: 178,
      popular: true,
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1551106652-a5bcf4b29ab6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      description: "Pack of 6 • NY style",
      price: 160,
      rating: 4.7,
      reviews: 121,
      popular: false,
      ...
      <div className="container mx-auto py-12">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Our customers can't get enough of these handcrafted treats made with
            premium ingredients
          </p>
        </div>
        ...
        <div className="text-center mt-20">
          <button className="bg-[#009F8A] text-white font-black px-16 py-5 rounded-full text-xl transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:bg-[#00b399]">
            EXPLORE ALL BAKES
          </button>
        </div>
      </div>
