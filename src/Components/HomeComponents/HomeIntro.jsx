            ...
            <div className="order-2 lg:order-1 flex flex-col justify-center">
              ...
              >
                <div className="space-y-6">
                  {/* Decorative Line */}
                  <div className="w-24 h-1 bg-gradient-to-r from-[#009F8A] to-teal-500 rounded-full"></div>

                  {/* Main Text */}
                  <h2 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black leading-[0.9] text-gray-900 tracking-tight">
                    <span className="block">GOOD FOOD</span>
                    <span className="block text-[#009F8A]">SHOULD BOTH</span>
                    <span className="block">COMFORT</span>
                    <span className="block">AND NOURISH</span>
                    <span className="block text-[#009F8A]">THE SOUL.</span>
                  </h2>
                  ...
                  >
                    <button className="group mt-8 bg-gradient-to-r from-[#009F8A] to-teal-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-xl hover:scale-105 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={index} className="group cursor-pointer">
                  <div className="text-3xl lg:text-4xl font-black text-[#009F8A] mb-2 group-hover:scale-110 transition-transform duration-300">
                    {stat.number}
                  </div>
