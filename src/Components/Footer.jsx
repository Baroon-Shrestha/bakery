...
export default function Footer() {
  return (
    <footer className="relative bg-teal-800 text-white pt-20 pb-12 px-6 md:px-16 overflow-hidden">
      {/* Top Curved Wave */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-white/90 leading-relaxed mb-6 text-sm">
            Crafting artisanal breads, pastries, and desserts since 1995. Every
            bite tells a story of passion, tradition, and the finest ingredients
